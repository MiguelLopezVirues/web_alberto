...
import { resolveMobilePhoto } from '@/tokens/mobilePhoto';
...
export default async function Home() {
  ...
  // Sanity does the crop server-side using hotspot + crop rectangle, so what
  ...
  const mobilePhoto = resolveMobilePhoto(appearance?.mobilePhoto);
